...
from RuiJinModule.XXGKIndexColumn.ScanPageHtml import getLinkHTML,getIndexHtmlLink,FormatLink
from RuiJinModule.XXGKIndexColumn.ScanHttpLink import ScanPageLink
from RuiJinModule.XXGKIndexColumn.MakeReport import ScanReport

#检测配置文件中的链接，并生成检测报告
# mkpath = ['bmxxgkTest', 'bmxxgkLinkTest', 'bmxxgkLinkHttpTest', 'bmxxgkLinkHttpStatusTest', 'bmxxgkbg']
def getAllLinkHTML(ColumnTimeLimit,currPath,UI,link_list_http_file,bmlink_list,bmlink_title_list,bm_httpstatus_file,link_list_file,
    ...
    strTmp = ScanReport(ColumnTimeLimit,currPath,UI,bm_httpstatus_file,FileName_time_int,bmlink_title_list,FileName_time,bmlink_list)
    UI.ScanTextEdit.append(strTmp)
