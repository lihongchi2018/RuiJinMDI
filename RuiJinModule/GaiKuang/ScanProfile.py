...
from RuiJinModule.GaiKuang.ScanPage import getAllLinkHTML
import win32api


class ScanGaiKuang(QWidget):
    def __init__(self, UIBtn, UI, MainWindow):
        super(ScanGaiKuang, self).__init__()
        self.initUi(UIBtn, UI, MainWindow)

    def initUi(self, UIBtn, UI, MainWindow):
        UI.ScanTextEdit.append("Start GaiKuang Module ... ...")
        currPath="./RuiJinModule/GaiKuang"
        ...
        ProfilePath = "/Profile/bmgkxx_GaiKuang.profile"
