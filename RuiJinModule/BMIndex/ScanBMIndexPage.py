...
from RuiJinModule.BMIndex.ScanIndexHtml import getLinkHTML,getIndexHtmlLink,FormatLink
from RuiJinModule.BMIndex.ScanLink import ScanPageLink,ScanReport
