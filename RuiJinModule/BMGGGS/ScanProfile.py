...
from RuiJinModule.BMGGGS.ScanPage import getAllLinkHTML
import win32api


class ScanBMGGGS(QWidget):
    def __init__(self, UIBtn, UI, MainWindow):
        super(ScanBMGGGS, self).__init__()
        self.initUi(UIBtn, UI, MainWindow)

    def initUi(self, UIBtn, UI, MainWindow):
        UI.ScanTextEdit.append("Start BMGGGS Module ... ...")
        currPath="./RuiJinModule/BMGGGS"
        ...
        ProfilePath = "/Profile/bmgkxx_bmgggs.profile"
